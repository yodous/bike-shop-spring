INSERT INTO USERS(ID, USERNAME, PASSWORD, FIRST_NAME, LAST_NAME, EMAIL_ADDRESS, ACC_NUMBER, CITY, STREET, POSTAL_CODE,
                 CREATED_AT, MODIFIED_AT)
VALUES (1, 'seller', 'password', 'firstName0', 'lastName0', 'seller@email.com', 'account number 0', 'city0', 'street0',
        '50-123', NOW(), NOW());
INSERT INTO USERS(ID, USERNAME, PASSWORD, FIRST_NAME, LAST_NAME, EMAIL_ADDRESS, ACC_NUMBER, CITY, STREET, POSTAL_CODE,
                 CREATED_AT, MODIFIED_AT)
VALUES (2, 'seller1', 'password', 'firstName1Seller', 'sellerlastName0', 'seller1@email.com', 'account number 12',
        'city5', 'street6', '70-123', NOW(), NOW());

INSERT INTO USERS(ID, USERNAME, PASSWORD, FIRST_NAME, LAST_NAME, EMAIL_ADDRESS, ACC_NUMBER, CITY, STREET, POSTAL_CODE,
                 CREATED_AT, MODIFIED_AT)
VALUES (3, 'consumer0', 'password', 'consumerName0', 'consumerlastName0', 'cons0@email.com', 'account number 1', 'city1',
        'street1', '11-123', NOW(), NOW());
INSERT INTO USERS(ID, USERNAME, PASSWORD, FIRST_NAME, LAST_NAME, EMAIL_ADDRESS, ACC_NUMBER, CITY, STREET, POSTAL_CODE,
                 CREATED_AT, MODIFIED_AT)
VALUES (4, 'consumer1', 'password', 'consumer1Name', 'conslastName1', 'cons1@email.com', 'account number 2', 'city2',
        'street2', '22-123', NOW(), NOW());
