...
class AuthServiceImplTest {
    ...
    @Mock private  AccountActivationTokenRepository authTokenRepository;
    ...
    void signup_WhenSignupRequestIsValid_ThenOk() {
        ...
        User user = new User("user", "password", "firstname",
                "lastname", "test@email.io", "1234 5678 8765 4321", testAddress);
        SignupRequest signupRequest = new SignupRequest(
                "user", "password", "password","firstname", "lastname",
                "test@email.io", "1234 5678 8765 4321", "city", "street", "12-345");
